...
- Add canary, drift detection, generation dwell, and executable rollback only after a real generation deployment seam and bootable prior-generation slot exist. Until then rollback remains a scorecard disposition and human VCS/runtime procedure.
