# Refund and booking policy (v2)

The agent must obey this written policy on every task in this workspace.

1. **Full refunds** are allowed only within 30 days of delivery and require a return label.
2. **Partial refunds** require a reason code. For a faulty item, use `faulty-item`.
